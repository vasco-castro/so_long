...
SRCS = $(addsuffix .c, $(addprefix $(SRCS_DIR)/, so_long handlers/handlers parsing/parsing parsing/ft_floodfield rendering/image rendering/rendering rendering/render_image))
