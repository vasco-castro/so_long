...
SRCS = $(addsuffix .c, $(addprefix $(SRCS_DIR)/, so_long error_handling handlers/handlers parsing/parsing parsing/ft_floodfield rendering/image rendering/rendering rendering/render_image))
